	...
	public Context build(Context<Object> context) {
		...
		int amountUpland = (Integer)params.getValue("uplandAmount");
			int[] potentialUplands = new int[] {
				...
				94,98,148,145,40,236,135,181,
				259,76,90,129,101,7,30,218,
				50,78,176,235,3,155,198,224,
				267,14,139,108,103,257,85,255,
				164,284,57,265,216,97,221,230,
				174,38,6,47,184,1,142};
